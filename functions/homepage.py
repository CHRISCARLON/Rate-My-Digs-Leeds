...
def provide_feedback_function():
    # Set up feedback box
    feedback = st.text_input(label="Please write your suggestion here:", value="", max_chars=500, key="feedback_input", placeholder="Type here...")
...
def homepage_function():
    ...
    *Rate My Digs* is a simple platform aimed at improving the rental experience of people living in Leeds, particularly for those in Houses in Multiple Occupation (HMOs).
    ...
    st.write("**Please click on the navigation bar in the top left corner to view and select pages.**")
